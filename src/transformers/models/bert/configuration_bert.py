...
class BertConfig(PretrainedConfig):
    ...
    Args:
        ...
        type_vocab_size (`int`, *optional*, defaults to 1):
            ...
            This modernized BERT variant defaults to 1 (like RoBERTa/ModernBERT), meaning token_type_ids
            are not used to distinguish sentence pairs. The model learns sentence boundaries through
            the [SEP] token and self-attention. Set to 2 for compatibility with original BERT behavior
